...
function MyApp({ Component, pageProps }) {
  ...
  return <Layout className="h-full min-h-screen">
    <TopProgressBar />
    <Head>
      <title className="font-Charm">{title}</title>
      <meta name="viewport" content="initial-scale=1.0, width=device-width" />
    </Head>
    <Sider trigger={null} collapsible breakpoint="lg" width="13em" collapsedWidth="45" defaultCollapsed={isMobile} collapsed={collapsed}>
      <Menu theme="dark" mode="inline" defaultSelectedKeys={defaultSelectedKeys} selectedKeys={defaultSelectedKeys} onClick={handleMenuClick} >
        ...
        <SubMenu key="admin" icon={<PieChartOutlined />} title="แอดมิน">
