                ...
                <div key={index} className="mt-3 h-1/4 ">
                    ...
                    <div>
                        <p className={index % 2 === 0
                            ? "pr-1 text-4xl font-thin text-right border-r-2 border-blue-600 lg:text-4xl "
                            : "pl-1 text-4xl font-thin border-l-2 border-green-600 lg:text-4xl "}>{title || ""}</p>
                        <p className={index % 2 === 0 ? "-mt-2 text-right w-full text-lg" : "pr-2 text-lg -mt-3 text-left w-full"}>{content || ""}
